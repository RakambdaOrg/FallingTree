...
public class ClothConfigHook{
	...
	private BaseComponent[] getTooltips(String category, String fieldName, int count){
	...
	public static Function<String, Optional<BaseComponent>> getMinecraftBlockIdCellError(){
	...
	public static Function<String, Optional<BaseComponent>> getMinecraftItemIdCellError(){
		return value -> Optional.ofNullable(value)
				.map(v -> MINECRAFT_ID_PATTERN.matcher(v).matches())
				.filter(v -> !v)
