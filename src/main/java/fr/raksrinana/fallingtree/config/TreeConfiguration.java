...
public class TreeConfiguration{
	...
	private static final String DESC_TREE_BREAKING = "When set to true, the mod will cut trees with one cut.";
	private static final String DESC_LEAVES_BREAKING = "When set to true, leaves that should naturally break will be broken instantly.";
	...
	private static final String DESC_BREAK_NETHER_TREE_WARTS = "When set to true nether tree warts (leaves) will be broken along with the trunk.";
	...
	public void fillConfigScreen(ConfigBuilder builder){
		...
		IntegerListEntry minimumLeavesAroundRequiredEntry = builder.entryBuilder()
				...
				.setMin(0)
				.setMax(5)
				.setTooltip(new StringTextComponent(String.join("\n", DESC_MINIMUM_LEAVES_AROUND_REQUIRED)))
