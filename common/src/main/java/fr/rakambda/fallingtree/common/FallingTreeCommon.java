...
import fr.rakambda.fallingtree.common.tree.TreeHandlerFactory;
...
public abstract class FallingTreeCommon<D extends Enum<D>>{
	...
	private final TreeHandlerFactory treeHandlerFactory;
	...
	public FallingTreeCommon(){
		...
		treeHandlerFactory = new TreeHandlerFactory(this);
	...
	@NonNull
	public TreeHandler getTreeHandler(@NonNull ILevel level, @NonNull IPlayer player, @NonNull IBlockPos originPos, @NonNull IBlockState originState, @Nullable IBlockEntity originEntity){
		return treeHandlerFactory.create(level, player, originPos, originState, originEntity);
	}
